...
public class GEMenuFile extends JMenu {
	...
	public void setACC(JMenuItem item) {
		if (item.getActionCommand().equals("새로만들기")) {
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
					InputEvent.CTRL_DOWN_MASK));
		} else if (item.getActionCommand().equals("열기")) {
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,
					InputEvent.CTRL_DOWN_MASK));
			// Open 단축키 설정
		} else if (item.getActionCommand().equals("저장")) {
			this.addSeparator();
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
					InputEvent.CTRL_DOWN_MASK));
			// Save 단축키 설정
		} else if (item.getActionCommand().equals("다른이름으로저장")) {
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
					InputEvent.CTRL_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK,
					false));
			// SaveAs 단축키 설정
		} else if (item.getActionCommand().equals("종료")) {
			this.addSeparator();
